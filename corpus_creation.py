...
def main():
    ...
    path_list = glob.glob('/Users/mk1989f_a/NUGoogleDrive/Resources/Northwestern-MSDS-master/MSDS 453/airline_safety_nlp/raw_data/*.txt')
    ...
    pd.DataFrame(corpus).to_csv('/Users/mk1989f_a/Desktop/corpus.csv', index=file_list)
